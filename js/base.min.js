...
//==============	
	$(".filter_element .filter_element__heading").on('click', function(){
		$(this).parent().toggleClass("active"); 
	});
...
//==============
	...
	$('#product-content .product-content-nav.tabs a:first, #product-content .product-content.tabs .list:first').addClass('active');
	
	$('#product-content .product-content-nav.tabs').on('click', 'a', function(e){
		e.preventDefault();
